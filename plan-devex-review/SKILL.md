...
description: |
  ...
  (APIs, CLIs, SDKs, libraries, platforms, docs). (nstack)
...
~/.claude/skills/nstack/bin/nstack-timeline-log '{"skill":"plan-devex-review","event":"started","branch":"'"$_BRANCH"'","session":"'"$_SESSION_ID"'"}' 2>/dev/null &
...
3. Run `~/.claude/skills/nstack/bin/gstack-team-init required` (or `optional`)
...
```bash
eval "$(~/.claude/skills/nstack/bin/gstack-slug 2>/dev/null)" 2>/dev/null || true
...
\`~/.claude/skills/nstack/plan-devex-review/dx-hall-of-fame.md\`
...
Load the "## Pass 1" section from `~/.claude/skills/nstack/plan-devex-review/dx-hall-of-fame.md`
...
```bash
eval "$(~/.claude/skills/nstack/bin/nstack-slug 2>/dev/null)"
~/.claude/skills/nstack/bin/nstack-review-read 2>/dev/null | grep plan-devex-review || echo "NO_PRIOR_DX_REVIEWS"
```
...
Load reference: Read the "## Pass 1" section from `~/.claude/skills/nstack/plan-devex-review/dx-hall-of-fame.md`.
...
Load reference: Read the "## Pass 2" section from `~/.claude/skills/nstack/plan-devex-review/dx-hall-of-fame.md`.
...
Load reference: Read the "## Pass 3" section from `~/.claude/skills/nstack/plan-devex-review/dx-hall-of-fame.md`.
...
Load reference: Read the "## Pass 4" section from `~/.claude/skills/nstack/plan-devex-review/dx-hall-of-fame.md`.
...
Load reference: Read the "## Pass 5" section from `~/.claude/skills/nstack/plan-devex-review/dx-hall-of-fame.md`.
...
Load reference: Read the "## Pass 6" section from `~/.claude/skills/nstack/plan-devex-review/dx-hall-of-fame.md`.
...
Load reference: Read the "## Pass 7" section from `~/.claude/skills/nstack/plan-devex-review/dx-hall-of-fame.md`.
...
Load reference: Read the "## Pass 8" section from `~/.claude/skills/nstack/plan-devex-review/dx-hall-of-fame.md`.
...
This is NOT a scored pass. It's a checklist of proven patterns from nstack's own DX.
...
`~/.nstack/` (user config directory, not project files).

```bash
~/.claude/skills/nstack/bin/nstack-review-log '{"skill":"plan-devex-review","timestamp":"TIMESTAMP","status":"STATUS","initial_score":N,"overall_score":N,"product_type":"TYPE","tthw_current":"TTHW_CURRENT","tthw_target":"TTHW_TARGET","mode":"MODE","persona":"PERSONA","competitive_tier":"TIER","pass_scores":{"getting_started":N,"api_design":N,"errors":N,"docs":N,"upgrade":N,"dev_env":N,"community":N,"measurement":N},"unresolved":N,"commit":"COMMIT"}'
```
...
```bash
~/.claude/skills/nstack/bin/nstack-learnings-log '{"skill":"plan-devex-review","type":"TYPE","key":"SHORT_KEY","insight":"DESCRIPTION","confidence":N,"source":"SOURCE","files":["path/to/relevant/file"]}'
```
