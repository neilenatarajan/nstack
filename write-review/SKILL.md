...
- Hook line first, single-line-break paragraphs, no headers, ends with question/CTA, ~1200-1500 chars → linkedin post
...
- **LinkedIn post:** Does the first line earn the click in <210 chars (the "see more"
  truncation point)? Is the hook specific (a number, claim, contrarian take), not
  generic ("Today I want to share..." / "I've been thinking about...")? Are paragraphs
  short (1-2 sentences each, separated by single blank lines)? Is the total length
  in the 1200-1500 char sweet spot (under 800 feels thin; over 2000 truncates)? Does
  it end with a question or CTA that invites engagement? Are hashtags restrained
  (0-3 max, end of post)? Is it first-person and conversational (not thought-leader
  voice)?
